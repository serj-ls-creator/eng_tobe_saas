...
export default async function ChoicePlaceholderPage({ params }: PageProps) {
      ...
      <div className="content-shell">
        ...
        <div className="mb-6">
          <Card className="border border-dashed border-white/10 p-8 text-center">
            ...
            <h3 className="mb-2 text-lg font-semibold">Choice Activity</h3>
            <p className="text-sm leading-relaxed text-zinc-500 mb-4">
              Pick the best response in dialogues
            </p>
            <div className="text-xs text-cyan-400">
              {topic.name} → {subcategory.name} → Choice
            </div>
            {locked && (
