...
export default async function ListenPickPage({ params }: { params: { categoryId: string; levelId: string } }) {
  ...
  return (
    <>
      <TopBar title={`${category.name} - ${levelName} - Listen & Pick`} />
        ...
        <Card className="p-8">
          <div className="text-center">
            ...
            <p className="text-zinc-400 mb-6">
              Listen and select the correct idiom
            </p>
            <div className="p-6 bg-yellow-500/10 border border-yellow-500/20 rounded-lg">
              <p className="text-yellow-400">
                This activity is coming soon! We're working on adding audio features for listening practice.
              </p>
            </div>
          </div>
        </Card>
