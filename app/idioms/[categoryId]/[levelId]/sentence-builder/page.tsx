...
export default async function SentenceBuilderPage({ params }: { params: { categoryId: string; levelId: string } }) {
  ...
  return (
    <>
      <TopBar title={`${category.name} - ${levelName} - Sentence Builder`} />
          ...
          <div className="text-center">
            ...
            <div className="p-6 bg-yellow-500/10 border border-yellow-500/20 rounded-lg">
              <p className="text-yellow-400">
                This activity is coming soon! We're working on creating sentence building exercises with idioms.
              </p>
            </div>
          </div>
        </Card>
