...
export default async function FillBlanksPage({ params }: { params: { categoryId: string; levelId: string } }) {
  ...
  return (
    <>
      <TopBar title={`${category.name} - ${levelName} - Fill the Blanks`} />
        ...
        <Card className="p-8">
          <div className="text-center">
            ...
            <p className="text-zinc-400 mb-6">
              Complete the idiom sentences
            </p>
            <div className="p-6 bg-yellow-500/10 border border-yellow-500/20 rounded-lg">
              <p className="text-yellow-400">
                This activity is coming soon! We're working on creating fill-in-the-blank exercises for idioms.
              </p>
            </div>
          </div>
        </Card>
