...
export const SILENT_WORD_LEVELS: SilentWordLevel[] = [
  ...
  },
  {
    ...
    words: [
      ...
      { word: "subtle", silentLetter: "b", silentIndex: 3 },
      ...
      { word: "castle", silentLetter: "t", silentIndex: 2 },
    ],
  },
  {
    id: "level-4",
    name: "Level 4",
    words: [
      { word: "listen", silentLetter: "t", silentIndex: 2 },
      ...
      { word: "receipt", silentLetter: "p", silentIndex: 4 },
    ],
  },
  {
    id: "level-5",
    ...
    words: [
      ...
      { word: "answer", silentLetter: "w", silentIndex: 2 },
  ...
  },
  {
    ...
    words: [
      ...
      { word: "foreign", silentLetter: "g", silentIndex: 6 },
  ...
  },
  {
    ...
    words: [
      ...
      { word: "folklore", silentLetter: "l", silentIndex: 3 },
  ...
  },
  {
    ...
    words: [
      ...
      { word: "vehicle", silentLetter: "h", silentIndex: 3 },
      { word: "mortgage", silentLetter: "t", silentIndex: 3 },
      { word: "Wednesday", silentLetter: "d", silentIndex: 3 },
      { word: "raspberry", silentLetter: "p", silentIndex: 3 },
      { word: "cupboard", silentLetter: "p", silentIndex: 2 },
      { word: "iron", silentLetter: "r", silentIndex: 2 },
      { word: "colonel", silentLetter: "l", silentIndex: 3 },
    ],
  },
];
